...
public class LocalTextToSpeechAudioStorage : ITextToSpeechAudioStorage
{
    private const string PublicFolder = "tts-audio";
    private readonly string _rootPath;

    public LocalTextToSpeechAudioStorage(IWebHostEnvironment environment)
    {
